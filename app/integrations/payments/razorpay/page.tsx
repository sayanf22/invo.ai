          ...
          <div className="rounded-[2rem] border border-slate-200/60 dark:border-slate-800/60 bg-white dark:bg-slate-900 p-8 shadow-sm">
            ...
            <DashboardMockup title="dashboard.razorpay.com/app/keys">
              <div className="flex h-64 text-sm">
                {/* Sidebar */}
                <div className="w-48 bg-[#0B1527] border-r border-[#1C2C47] p-4 hidden sm:block text-slate-400">
                  ...
                  <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-4 bg-white dark:bg-slate-950 shadow-sm">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="font-mono text-xs bg-slate-100 dark:bg-slate-900 p-2 rounded border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200">rzp_live_abc123xyz</div>
                      </div>
                      <div>
                        <div className="text-xs text-slate-500 mb-1">Key Secret</div>
                        <div className="font-mono text-xs bg-slate-100 dark:bg-slate-900 p-2 rounded border border-slate-200 dark:border-slate-800 text-slate-400">••••••••••••••••••••••••••••</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-12">
          ...
          <div className="rounded-[2rem] border border-slate-200/60 dark:border-slate-800/60 bg-white dark:bg-slate-900 p-8 shadow-sm">
            ...
            <DashboardMockup title="dashboard.razorpay.com/app/webhooks">
              <div className="flex h-[320px] text-sm">
                {/* Sidebar */}
                <div className="w-48 bg-[#0B1527] border-r border-[#1C2C47] p-4 hidden sm:block text-slate-400">
                  <div className="h-6 w-24 bg-[#1C2C47] rounded mb-6"></div>
                  <div className="space-y-3">
                ...
                <div className="flex-1 p-6 bg-slate-50 dark:bg-slate-900 overflow-y-auto">
                  ...
                  <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-4 bg-white dark:bg-slate-950 shadow-sm relative">
                    ...
                    <div className="font-mono text-xs bg-slate-100 dark:bg-slate-900 p-2 rounded border border-slate-200 dark:border-slate-800 text-slate-400 mb-4">
                      ••••••••••••••••
                    </div>
