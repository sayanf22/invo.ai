...
export default function RefundPolicyPage() {
    return (
        <LegalPageLayout title="Refund & Cancellation Policy" lastUpdated="April 10, 2026">
            ...
            <h2>3. Free Tier</h2>
            <p>The Free tier requires no payment and can be used indefinitely within its monthly limits (shown on the <a href="/pricing">Pricing page</a> and in your account). No refund applies to the Free tier.</p>
