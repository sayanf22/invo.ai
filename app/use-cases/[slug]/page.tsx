...
const USE_CASES: Record<string, UseCaseData> = {
    ...
    agents: {
        ...
        faqs: [
            ...
            { question: "Can agents create country-specific documents with Clorefy?", answer: "Yes. Clorefy supports 11 countries and automatically applies the correct tax rules, currency formatting, and legal requirements for each market." },
