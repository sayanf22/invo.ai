...
import { CheckCircle2, ArrowRight, Briefcase, Code2, GraduationCap, Palette, TrendingUp, Users } from "lucide-react"
...
const USE_CASES: Record<string, UseCaseData> = {
    freelancers: {
        ...
        faqs: [
            ...
            { question: "Does Clorefy support multiple currencies for international freelance work?", answer: "Absolutely. Clorefy supports every country worldwide and their currencies, automatically applying the correct tax rules and currency formatting for each." },
        ],
    },
    developers: {
        ...
        faqs: [
            { question: "Can Clorefy generate proposals with country-specific compliance?", answer: "Yes. Clorefy automatically applies country-specific tax rules, legal requirements, and formatting standards for every country worldwide when generating proposals and contracts." },
    ...
    agents: {
        title: "Clorefy for Agents",
        tagline: "Close deals with speed",
        desc: "Generate client proposals, service agreements, and quotations in seconds. Spend less time on paperwork, more time building relationships and closing deals.",
        metaDescription: "Clorefy helps agents create AI-generated proposals, service agreements, and quotations instantly with country-specific compliance and professional exports.",
        iconName: "TrendingUp",
        color: "from-orange-100 to-orange-50",
        benefits: ["Instant proposal generation", "Service agreement templates", "Custom pricing & terms", "Professional PDF exports", "Multi-country compliance", "Client-ready in seconds"],
        stats: [{ label: "Faster deal close", value: "3×" }, { label: "Time saved per doc", value: "15 min" }],
        relatedTools: [
            { href: "/tools/proposal-generator/india", label: "Proposal Generator for India" },
        ...
        faqs: [
            { question: "How does Clorefy help agents generate proposals faster?", answer: "Clorefy generates polished proposals and service agreements from a simple description of your offering. Just describe the deal, client, and terms — Clorefy handles formatting and compliance automatically." },
            { question: "Can agents create country-specific documents with Clorefy?", answer: "Yes. Clorefy supports every country worldwide and automatically applies the correct tax rules, currency formatting, and legal requirements for each market." },
            { question: "Does Clorefy support professional PDF exports for client presentations?", answer: "Absolutely. Every document generated by Clorefy can be exported as a professional PDF, ready to send to clients or print for in-person meetings." },
        ],
    },
    agencies: {
