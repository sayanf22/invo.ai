        ...
        headers: [
          ...
          // Content Security Policy (environment-aware)
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.supabase.co https://*.razorpay.com https://*.r2.cloudflarestorage.com",
              "connect-src 'self' blob: data: https://*.supabase.co https://api.deepseek.com https://api.openai.com https://api.razorpay.com https://lumberjack.razorpay.com https://*.r2.cloudflarestorage.com",
