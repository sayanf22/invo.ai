  ...
  return [
    ...
    { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=(), payment=(self https://checkout.razorpay.com), usb=()" },
    {
      ...
      value: [
        ...
        "connect-src 'self' blob: data: https://*.supabase.co wss://*.supabase.co https://api.deepseek.com https://api.openai.com https://api.razorpay.com https://lumberjack.razorpay.com https://api.cashfree.com https://api.stripe.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com",
